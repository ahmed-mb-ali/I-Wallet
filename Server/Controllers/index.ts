...
export function DisplayDocumentPage(req: Request, res: Response, next: NextFunction): void
{
    res.render('index', { title: 'Documents', page: 'document', displayName: UserDisplayName(req)   });
}
