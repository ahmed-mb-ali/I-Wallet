...
import { DisplayDocumentPage, DisplayContactPage, DisplayHomePage, DisplayLoginPage, DisplayNotificationPage, DisplayRegisterPage, DisplayUserProfilePage, ProcessLoginPage, ProcessLogoutPage, ProcessRegisterPage } from '../Controllers/index';
...
/* GET document page. */
router.get('/documents', DisplayDocumentPage);
